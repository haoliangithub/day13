...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="tbEmpName" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">性别 </span>
			      <input type="radio" name="tbEmpSex" id="txt_search_tbEmpSex1" value="1">男
			      <input type="radio" name="tbEmpSex" id="txt_search_tbEmpSex2" value="0">女
			    </div>
			  </div><div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">年龄 </span>
			      <input type="text" name="tbEmpAge" id="txt_search_tbEmpAge1" >-
			      <input type="text" name="tbEmpAge" id="txt_search_tbEmpAge2" >
			      </div>
			  </div></div><div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">生日 </span>
			      <input type="Date" name="tbEmpBirthday" id="txt_search_tbEmpBirthday1" >-
			      <input type="Date" name="tbEmpBirthday" id="txt_search_tbEmpBirthday2" >
			      </div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员头像</td>
								<td colspan="4">
									<input type="hidden"  id="tbEmpImg" name="tbEmpImg" >
									<input type="file"  id="tbEmpImg" name="photo" >
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user_import" method="post" enctype="Multipart/form-data" action="importemp.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>文件上传:</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_import_btn">上传</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	var TableInit = function () {
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                title: '人员头像',
	                formatter:function(value,row,index){
	                	return "<img witch='30' height='30' src='"+value+"'>";
	                }
	            },
	            {
	                field: 'tbEmpBirthday',
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            tbEmpName: $("#txt_search_username").val(),
	            ...
	            tbEmpDid: $("#txt_search_roleid").val(),
