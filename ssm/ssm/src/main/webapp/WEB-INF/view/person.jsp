...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="pName" class="form-control" id="txt_search_pername" >
				</div>
			  </div><div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">公司: </span>
			      <select class="form-control" name="pid" id = "txt_search_pid" aria-required="true" required>
						<option value="">---请选择---</option>
						<c:forEach items="${list }" var="l">
						<option value="${l.companyId }">${l.companyName }</option>
					</c:forEach>
				</select>
				</div>
			  </div>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_per" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>员工性别：</td>
								<td> <input type="radio" id="gender1" name="gender" value="1">男
							...
							<tr>
								...
								<td>入职日期</td>
								<td><input type="date" id="ceratetime" name="ceratetime"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>部门：</td>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_user_per').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_per').modal('show');
	        });
	...
	function initEditUser(getSelection){
		...
		$('#ceratetime').val(new Date(getSelection.ceratetime).Format('yyyy-MM-dd'));
